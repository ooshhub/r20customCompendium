...
const loadScripts = () => {
	...
	createScript(`ff/Scripts/helpers.js`);
	createScript(`ff/Scripts/classes.js`);
    createScript("ff/Scripts/extendUI.js");
	createScript(`ff/Systems/${ccGameSystem}/customCompendium5e.js`);
	createScript(`ff/Systems/${ccGameSystem}/helpers5e.js`);
	createScript(`ff/Scripts/menu.js`);
	createScript(`ff/Utils/FileSaver.js`);
	createScript(`ff/Utils/occCC.js`);
...
document.getElementById('ccCustomEvents').addEventListener('customInject', (event) => {
	...
	const loadScripts = () => {
		...
		createScript(`ff/Systems/${ccGameSystem}/sheetFluffer5e.js`);
